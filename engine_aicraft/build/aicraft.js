...
AICRAFT.Player.prototype.updateInput = function(a) {
  void 0 !== a && (Ammo = a);
  a = this.phybody.getLinearVelocity();
  a = Math.sqrt(a.getX() * a.getX() + a.getY() * a.getY() + a.getZ() * a.getZ());
  AICRAFT.ClientEngine.key(this.keycode, "w") && a < this.maxSpeed && 1 > this.position.y && AICRAFT.Player.ahead(this, !0);
  AICRAFT.ClientEngine.key(this.keycode, "a") && a < this.maxSpeed && 1 > this.position.y && AICRAFT.Player.side(this, !0);
  AICRAFT.ClientEngine.key(this.keycode, "s") && a < this.maxSpeed && 1 > this.position.y && AICRAFT.Player.ahead(this, !1);
  AICRAFT.ClientEngine.key(this.keycode, "d") && a < this.maxSpeed && 1 > this.position.y && AICRAFT.Player.side(this, !1);
  AICRAFT.ClientEngine.key(this.keycode, "e") && 0.1 > this.position.y && (this.phybody.activate(), a = new Ammo.btVector3(0, 0, 0), this.phybody.applyCentralImpulse(a))
};
...
AICRAFT.CameraControl = function(a, b, c) {
  ...
  this.deltaY = this.prevMouseY = this.mouseY = this.deltaX = this.prevMouseX = this.mouseX = 0;
  this.mouseDragOn = !1;
  this.speed = 100;
...
AICRAFT.ClientEngine.prototype = {constructor:AICRAFT.ClientEngine, init:function(a) {
  ...
  if(!(void 0 === this.players[this.myPnum] || void 0 === this.myPnum)) {
    var a = io.connect("/");
    0 != this.players[this.myPnum].keycode ? (a.emit("k", this.players[this.myPnum].keycode), this.players[this.myPnum].updateInput()) : 0 == this.players[this.myPnum].keycode && 0 != this.lastKeycode && a.emit("k", 0);
