...
}, setPos:function(b, a, c, d, e, f, g, h, i, j, k) {
  void 0 !== b && (Ammo = b);
...
AICRAFT.ClientEngine.prototype = {constructor:AICRAFT.ClientEngine, init:function(b) {
  ...
  a.on("a", function(a) {
    for(var a = AICRAFT.Engine.extractPacket(a).bindings, d = 0;d < b.totalPlayers;d++) {
      b.ais[d].setPos(Ammo, a[d].position[0], a[d].position[1], a[d].position[2], a[d].quaternion[0], a[d].quaternion[1], a[d].quaternion[2], a[d].quaternion[3], a[d].velocity[0], a[d].velocity[1], a[d].velocity[2])
    }
  })
}, syncKey:function() {
