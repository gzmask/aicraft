...
AICRAFT.Ai = function(a, b, c, d, e, f, g, h) {
  ...
  this.hp = 100;
  this.onSightFound = this.owner = this.name = this.turnMesh = this.walkMesh = void 0
};
...
AICRAFT.Ai.prototype.buildMesh = function(a, b, c) {
  var d = this;
  AICRAFT.Ai.JSONloader(d, "asset/rat_walk.js", !0, b, c, a, function() {
    d.mesh.visible = !0
  });
...
AICRAFT.Ai.JSONloader = function(a, b, c, d, e, f, g) {
  (new f.JSONLoader).load(b, function(b) {
    var k = b.materials[0];
    k.morphTargets = !0;
    k.color.setHex(e);
    k.ambient.setHex(2236962);
    k = new f.MeshFaceMaterial;
    b = new f.MorphAnimMesh(b, k);
    b.duration = 1E3;
    b.time = 0;
    b.castShadow = !0;
    b.receiveShadow = !0;
    ...
    b.useQuaternion = !0;
    b.quaternion.set(a.quaternion.x, a.quaternion.y, a.quaternion.z, a.quaternion.w);
    b.scale.set(5, 5, 5);
    !0 === c ? a.walkMesh = b : a.turnMesh = b;
    a.mesh = b;
    d.add(b);
    b.visible = !1;
    void 0 !== g && g()
