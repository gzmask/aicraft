...
AICRAFT.Ai.rotate = function(a, b, c, d, f, e, g) {
  ...
  if(!0 === e || !0 === a.sight.lock) {
    h = AICRAFT.quatMul(k, i), a.sight.quaternion.x = h.getX(), a.sight.quaternion.y = h.getY(), a.sight.quaternion.z = h.getZ(), a.sight.quaternion.w = h.getW()
  }
  setTimeout(function() {
